...
browser credentials, or generated customer workspaces here.

Use restricted Sprite authorization. Do not create, destroy, restore, expose,
or widen access to a cloud resource unless the parent request explicitly
authorizes that exact action. Preserve unrelated changes, use `main`, and do
not edit sibling repositories. Return changed files, checks, cloud actions,
risks, branch, and absolute worktree.
